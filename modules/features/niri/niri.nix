        ...
        settings =
          ...
          in
          {
            ...
            binds = {
              ...
              "Mod+V".spawn-sh =
                "${lib.getExe config.pkgs.cliphist} list | ${lib.getExe config.pkgs.fuzzel} --dmenu | ${lib.getExe config.pkgs.cliphist} decode | ${config.pkgs.wl-clipboard}/bin/wl-copy";
              ...
              "Mod+Shift+R".spawn-sh = lib.getExe (
                config.pkgs.writeShellApplication {
                  name = "screenrecord";
                  text = ''
            ...
            spawn-at-startup = [
              noctaliaExe
              (lib.getExe' pkgs.kdePackages.kded "kded6")
            ];
