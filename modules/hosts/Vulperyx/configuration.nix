...
{ self, inputs, ... }: {
  ...
  flake.nixosModules.VulperyxConfiguration = { pkgs, lib, ... }: {
    ...
    networking.hostName = "Vulperyx"; # Define your hostname.
    ...
    hardware.nvidia = {
      ...
      open = false; # Set to true if you want the open-source kernel module
      nvidiaSettings = true;
      branch = "legacy_580"; # Instructs NixOS to use the 580 driver branch
    };
